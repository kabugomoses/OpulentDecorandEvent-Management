...
<head>
    ...
    <title>Opulent Decor & Events & Events Management | Luxury Event Decoration</title>
    ...
    <style>
        * {
        ...
        /* Mega Palette Grid - All 64 Colors Flat Display */
        .mega-palette-grid {
            display: grid;
            grid-template-columns: repeat(2, 1fr);
            gap: 1.2rem;
        ...
        .palette-option.selected {
            border-color: var(--gold);
            border-width: 4px;
            box-shadow: 0 0 40px rgba(212,175,55,0.6), 0 10px 30px rgba(0,0,0,0.4);
        ...
        .palette-color-block:last-child {
            border-right: none;
        }

        .palette-option:hover .palette-color-block {
            flex: 1.3;
        }
        ...
        .palette-option.selected .palette-name {
            background: linear-gradient(180deg, var(--gold), var(--rose-gold));
            color: var(--dark);
            font-weight: 800;
        }

        /* Scrollbar styling for the color grid */
        .mega-palette-grid::-webkit-scrollbar {
            width: 12px;
        }

        .mega-palette-grid::-webkit-scrollbar-track {
            background: rgba(0,0,0,0.3);
            border-radius: 10px;
        }

        .mega-palette-grid::-webkit-scrollbar-thumb {
            background: linear-gradient(var(--gold), var(--rose-gold));
            border-radius: 10px;
            border: 2px solid rgba(0,0,0,0.3);
        }

        .mega-palette-grid::-webkit-scrollbar-thumb:hover {
            background: var(--gold);
        }
...
<body>
    ...
    <nav>
        <div class="logo-container">
            <span class="logo-text">OPULENT DECOR & EVENTS & EVENTS MANAGEMENT</span>
        </div>
    ...
    <div class="page home-page active" id="home">
        <section class="hero-cinematic">
            <div class="hero-content">
                ...
                <h1 class="hero-title">OPULENT DECOR & EVENTS</h1>
    ...
    <div class="page about-page" id="about">
        ...
        <div class="about-content-split">
            ...
            <div class="about-text-side">
                ...
                <p>At Opulent Decor & Events & Events Management, we believe every celebration deserves to be nothing short of spectacular. With an eye for detail and a passion for luxury, we specialize in creating breathtaking environments that reflect your unique style and vision.</p>
        ...
        <div class="booking-container">
            ...
            <form id="bookingForm" onsubmit="submitToWhatsApp(event)">
                <div class="form-grid">
                    ...
                    <!-- ============================================ -->
                    <!-- COLOR PALETTE SELECTION - ALL 64 COLORS -->
                    <!-- ============================================ -->
                    <div class="palette-section" style="background: linear-gradient(135deg, rgba(212,175,55,0.15), rgba(183,110,121,0.1), rgba(0,0,0,0.5)); border: 3px solid var(--gold); box-shadow: 0 0 40px rgba(212,175,55,0.3);">
                        <div class="palette-header" style="margin-bottom: 2.5rem;">
                            <h3 style="font-size: 2.2rem; color: var(--gold); text-shadow: 0 0 20px rgba(212,175,55,0.5);">🎨 Choose Your Color Theme</h3>
                            <p style="color: rgba(255,255,255,0.9); margin-top: 1rem; font-size: 1.1rem; font-weight: 500;">👆 Click on ONE color palette below that matches your event vision</p>
                            <p style="color: var(--gold); margin-top: 0.5rem; font-size: 0.95rem;">✨ 64 stunning color combinations available ✨</p>
                        </div>

                        <!-- SELECTED THEME DISPLAY - Shows client choice prominently -->
                        <div id="selectedThemeDisplay" style="background: linear-gradient(135deg, rgba(212,175,55,0.3), rgba(183,110,121,0.2)); border: 4px solid var(--gold); border-radius: 20px; padding: 2.5rem; margin-bottom: 3rem; text-align: center; display: none; box-shadow: 0 10px 40px rgba(212,175,55,0.4);">
                            <p style="color: var(--gold); font-weight: 700; margin-bottom: 1rem; font-size: 1.3rem; text-transform: uppercase; letter-spacing: 3px; text-shadow: 0 0 10px rgba(212,175,55,0.5);">✓ Your Selected Theme:</p>
                            <div id="selectedThemeName" style="font-size: 1.8rem; color: var(--white); font-weight: 700; margin-bottom: 1.5rem; text-shadow: 0 0 15px rgba(255,255,255,0.3);"></div>
                            <div id="selectedColorsPreview" style="display: flex; justify-content: center; gap: 1.2rem; flex-wrap: wrap;"></div>
                        </div>

                        <!-- ALL 64 COLOR PALETTES - VISIBLE GRID -->
                        <div class="mega-palette-grid" id="megaPaletteGrid" style="max-height: 800px; overflow-y: auto; padding: 1rem; background: rgba(0,0,0,0.3); border-radius: 15px; border: 1px solid rgba(212,175,55,0.2);">
                            <!-- All 64 color palettes displayed here -->
                        </div>
                    ...
                    <div class="form-group full-width" style="grid-column: 1 / -1; margin-top: 1rem;">
                        <div style="background: linear-gradient(135deg, rgba(212,175,55,0.1), rgba(183,110,121,0.05)); border: 2px solid rgba(212,175,55,0.3); border-radius: 15px; padding: 2rem; margin-bottom: 1rem;">
                            <h4 style="color: var(--gold); font-family: 'Playfair Display', serif; margin-bottom: 1.5rem; font-size: 1.3rem; text-align: center;">🏛️ Venue Details</h4>

                            <div class="form-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                                <div class="form-group" style="grid-column: 1 / -1;">
                                    <label>Venue Name *</label>
                                    <input type="text" name="venueName" required placeholder="Enter venue name (e.g., Serena Hotel, Kampala)">
                                </div>

                                <div class="form-group">
                                    <label>District *</label>
                                    <input type="text" name="district" required placeholder="Enter district (e.g., Kampala, Wakiso, Mukono)">
                                </div>

                                <div class="form-group">
                                    <label>City/Area *</label>
                                    <input type="text" name="cityArea" required placeholder="Enter city or area">
                                </div>

                                <div class="form-group" style="grid-column: 1 / -1;">
                                    <label>Full Address with Landmarks *</label>
                                    <textarea name="fullAddress" rows="3" required placeholder="Enter complete address with nearby landmarks, directions, or notable buildings for easy location..."></textarea>
                                </div>

                                <div class="form-group">
                                    <label>Contact Person at Venue *</label>
                                    <input type="text" name="venueContactPerson" required placeholder="Name of person managing the venue">
                                </div>

                                <div class="form-group">
                                    <label>Venue Contact Number *</label>
                                    <input type="tel" name="venueContactPhone" required placeholder="Phone number of venue contact">
                                </div>

                                <div class="form-group" style="grid-column: 1 / -1;">
                                    <label>Venue Alternative Contact (Optional)</label>
                                    <input type="text" name="venueAltContact" placeholder="Alternative phone or email for venue">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <footer>
        ...
        <p style="color: rgba(255,255,255,0.4); font-size: 0.9rem;">&copy; 2026 Opulent Decor & Events & Events Management. All rights reserved.</p>
    </footer>
    ...
    <script>
        ...
        function selectPalette(name, colors, element) {
            ...
            // Update the selected theme display
            const display = document.getElementById('selectedThemeDisplay');
            const nameDiv = document.getElementById('selectedThemeName');
            const colorsDiv = document.getElementById('selectedColorsPreview');
            ...
            colorsDiv.innerHTML = colors.map(color => 
                `<div style="width: 30px; height: 30px; border-radius: 50%; background: ${color}; border: 2px solid white; box-shadow: 0 2px 8px rgba(0,0,0,0.3);"></div>`
            ).join('');
        ...
        function submitToWhatsApp(e) {
            ...
            message += "Sent from Opulent Decor & Events Website";
